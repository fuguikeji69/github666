...
function sleep(o) {
    for (var n = new Date, e = n.getTime() + o;;)
        if ((n = new Date).getTime() > e) return
}

function headAdbgcolor() {
    var o = window.location.pathname; - 1 != o.indexOf("SixFast") ? ($(".Fastkai").addClass("headcheli"), $(".bodybox .Fastkai").addClass("grey_after")) : -1 != o.indexOf("/index") ? $(".adindex").addClass("headcheli") : $("#HKcai").addClass("headcheli")
}

function random(o, n) {
    var e = Math.random() * (n - o),
        i = Math.round(e + o);
...
"stagingEnv" == url.env && (url.fast_Kai = "//stg-168-api.api861.com/", url.config140_2 = "//stg-x6-api.api861.com/"), url.config140 = url.config140_2 + "smallSix/", url.SixFastUrl = url.fast_Kai + "speedSix/", url.photoUrl = "//1687170.com/";
var tools = {},
    config = {
...
console.log = function() {
    ...
    $(this).hasClass("firstPage") || $("#kfu").hasClass("kfuIndex"), window.open("https://vue.livehelp100service.com/0349d3c82fa8964jkfle-keli43d7cd2fa19c448719b5003e443036a3a8c0f02fd104a028bb4bef76f69c262a", "winName", "top=150,left=100,width=400,height=600")
});
var publictools = {};
publictools.getToken = function() {
    return window.localStorage.token
}, publictools.testWWW = function() {
    -1 != window.location.href.indexOf("6hch00") ? ($(".brann_img").hide(), $("#init168").attr("href", "https://1689437.com"), $(".news_ad").attr("href", url.news_adurl_none)) : ($(".brann_img").show(), $(".news_ad").attr("href", url.news_adurl));
    var o = window.location.host,
        n = window.location.protocol + "//m." + (o = o.replace(/^www./, ""));
...
$(function() {
    $("#sixfastbox").load("public/sixfast_header.html", function() {
    ...
    }), $("#fooderbox").load("public/fooder.html", function() {}), $("#fooderbox,.footer,#fooderbox").on("click", "#gotop", function() {
...
$(document).scroll(function() {
    ...
    var o = navigator.userAgent.toLowerCase(),
        n = "ipad" == o.match(/ipad/i),
        e = "iphone os" == o.match(/iphone os/i),
        i = "midp" == o.match(/midp/i),
        t = "rv:1.2.3.4" == o.match(/rv:1.2.3.4/i),
        a = "ucweb" == o.match(/ucweb/i),
        s = "android" == o.match(/android/i);
    o.indexOf("android") > 0 && (s = !0);
    var d = "windows ce" == o.match(/windows ce/i),
        l = "windows mobile" == o.match(/windows mobile/i);
    if (n || e || i || t || a || s || d || l) {
        window.location.href;
        var r = window.location.host,
            c = window.location.protocol + "//m." + (r = r.replace(/^www./, ""));
